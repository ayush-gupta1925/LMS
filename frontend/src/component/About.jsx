...
function About() {
  return (
    <div className="w-[100vw] lg:h-[70vh] min-h-[50vh] flex flex-wrap items-center justify-center gap-2 mb-[30px]">
      {/* for image area  */}
      <div className="lg:w-[40%] md:w-[80%] w-[100%] h-[100%] flex items-center justify-center relative sm:mr-[10px] lg:mr-[-30px] mr-[10px]">
        <img src={about} className="w-[70%] h-[90%] rounded-lg" />
        <div className="max-w-[350px] max-auto p-4 absolute top-[55%] left-[55%]">
          <video
            src={video}
      ...
      <div className="lg:w-[50%] md:w-[70%] w-[100%] h-[100%] flex items-start justify-center flex-col px-[35px] md:px-[80px]">
        <div className="flex text-[25px] items-center justify-center gap-[20px] ">
          About Us <TfiLayoutLineSolid className="w-[40px] h-[40px]" />
        </div>
        <div className="md:text-[45px] text-[35px] font-semibold">
          We are Maxmimize your Learning Growth
        </div>

        <div className="text-[15px]">
          We provide a modern learning managment system to simplify online
